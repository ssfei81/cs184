...
Vector u_fluid(0.5, 0.5, 0.5); // fluid speed
...
Point clothCenter(32, clothHeight/2+2, -85);
Vector clothOrientX(1, 0, 0.1); // two directions to determine the orientation of the cloth
...
Point ballCenter(clothCenter.x + orientZ.x * ballDist + 20.5 - 7, ground + ballRadius + 1, clothCenter.z + orientZ.z * ballDist - 93);
float ballMass = 0.5;
